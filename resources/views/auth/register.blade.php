                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="first_name" class="col-md-4 col-form-label text-md-right">@lang('messages.f_name')</label>
                        ...
                        <div class="form-group row">
                            <label for="last_name" class="col-md-4 col-form-label text-md-right">@lang('messages.l_name')</label>
                        ...
                        <div class="form-group row">
                            <label for="username" class="col-md-4 col-form-label text-md-right">@lang('messages.username')</label>
